...
export default class PlaceDetails extends React.Component {
    ...
    close() {
        browserHistory.push(CORE_URL + 'map');
    }
        ...
        return <div className={'col-sm-12 col-md-3 sidebar ' + styles.details + ' ' + hiddenClass}>
            ...
            <div className='row'>
                ...
                <h1>
                    ...
                    <Link to={CORE_URL + 'map/edit/' + place._id}><span className='glyphicon glyphicon-edit'></span></Link>
                </h1>
                ...
                <p>
                    <Link to={CORE_URL + 'map'}><span className={'glyphicon glyphicon-chevron-left'}></span> назад</Link>
                </p>
            </div>
        </div>
    }
